...
#def layer_extraction(pretrained_weights = None,input_size = (256,256,1), loss_function = binary_crossentropy, drop_rate=0.5):
#    model = unet_Enze19_2_bayes(pretrained_weights=pretrained_weights, input_size=input_size, loss_function=loss_function, drop_rate=drop_rate)
#    extractor = K.Model(inputs=model.inputs,
#                        outputs
